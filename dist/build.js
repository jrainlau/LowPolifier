...
/* harmony default export */ exports["a"] = new __WEBPACK_IMPORTED_MODULE_1_vuex___default.a.Store({
	...
	mutations: {
		UPDATE_OPTIONS: function UPDATE_OPTIONS(state, _ref) {
			var type = _ref.type;
	...
	actions: {
		updateOptions: function updateOptions(_ref2, obj) {
 ...
 */
{
  ...
  if (typeof module === 'object' && typeof module.exports === 'object') {
    ...
    // AMD support
    !(__WEBPACK_AMD_DEFINE_FACTORY__ = (() => LowPoly), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.call(exports, __webpack_require__, exports, module)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__))
...
// module
exports.push([module.i, ".counter[data-v-07995b2e]{margin-bottom:5px}.counter .counter-name[data-v-07995b2e]{font-size:12px;display:inline-block;width:11rem;text-align:right;padding-right:1.5rem;box-sizing:border-box}.counter .counter-content[data-v-07995b2e]{font-size:0}.counter .counter-content button[data-v-07995b2e],.counter .counter-content input[data-v-07995b2e]{font-size:14px;text-align:center;outline:none}.counter .counter-content input[data-v-07995b2e]{border:1px solid #bbb;border-left:none;border-right:none;width:5rem;vertical-align:top}.counter .counter-content button[data-v-07995b2e]{border:1px solid #bbb;background:none;vertical-align:top}.counter .counter-content button[data-v-07995b2e]:active{background:#333;color:#fff}", ""]);
...
// module
exports.push([module.i, "body,html{padding:0;margin:0;font-size:14px;font-family:Microsoft Yahei,PingHei,Helvetica Neue,Helvetica,STHeitiSC-Light,Arial,sans-serif;color:#333}#app,body,html{height:100%;width:100%}#app{display:flex;flex-direction:column;justify-content:space-between;align-items:center}#app .head{width:100%}#app .head h1{font-size:0;border-bottom:1px solid #aaa;text-align:center;width:100%}#app .head h1 img{max-width:20%;max-height:60px;padding:5px 0}#app .head .output{background:#fff;border-bottom:1px solid #aaa;width:100%;height:40rem;text-align:center;margin-bottom:10px;display:flex;justify-content:center;align-items:center}#app .head .output img{max-width:100%;max-height:100%;object-fit:contain;cursor:pointer}@media (max-width:738px){#app .head .output{height:20rem}}#app .generate-btn{width:95%;height:4rem;margin-bottom:10px;background:none;border:1px solid #aaa;font-size:18px;outline:none}#app .generate-btn:active{background:#333;color:#fff}#app .generate-btn .fa{animation:spin 1.2s infinite}#app .generate-btn .hide{display:none}@keyframes spin{0%{transform:rotate(0)}to{transform:rotate(1turn)}}", ""]);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.9.7.0@vue-loader/lib/style-rewriter.js?id=data-v-07995b2e&scoped=true!./../../node_modules/.2.2.3@less-loader/index.js!./../../node_modules/.9.7.0@vue-loader/lib/selector.js?type=styles&index=0!./counter.vue", function() {
			var newContent = require("!!./../../node_modules/.0.25.0@css-loader/index.js!./../../node_modules/.9.7.0@vue-loader/lib/style-rewriter.js?id=data-v-07995b2e&scoped=true!./../../node_modules/.2.2.3@less-loader/index.js!./../../node_modules/.9.7.0@vue-loader/lib/selector.js?type=styles&index=0!./counter.vue");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../node_modules/.0.25.0@css-loader/index.js!./../node_modules/.9.7.0@vue-loader/lib/style-rewriter.js?id=data-v-e5357c44!./../node_modules/.2.2.3@less-loader/index.js!./../node_modules/.9.7.0@vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
			var newContent = require("!!./../node_modules/.0.25.0@css-loader/index.js!./../node_modules/.9.7.0@vue-loader/lib/style-rewriter.js?id=data-v-e5357c44!./../node_modules/.2.2.3@less-loader/index.js!./../node_modules/.9.7.0@vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lowpoly__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lowpoly___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lowpoly__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_counter_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_counter_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_counter_vue__);
//
//
//
//
...
/* harmony default export */ exports["default"] = {
  ...
  components: {
    Counter: __WEBPACK_IMPORTED_MODULE_1__components_counter_vue___default.a
  },
  methods: {
    ...
    styling: function styling() {
      ...
      var lowpoly = new __WEBPACK_IMPORTED_MODULE_0_lowpoly___default.a(this.src, {
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-07995b2e"
...
module.exports={render:function (){with(this) {
  return _h('div', {
    ...
    class: [working ? '' : 'hide', 'fa fa-spinner'],
    attrs: {
      "aria-hidden": "true"
    }
  }), " ", _h('span', {
